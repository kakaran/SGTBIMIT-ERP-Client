...
const UpdateDetails = ({ tempObject, setTempObject, setStoreData, storeData, index, setPopup, originalData }) => {
            ...
            <div className='w-1/2 h-1/2 rounded-md bg-white overflow-y-scroll flex flex-col'>
                ...
                <form onSubmit={(e) => handleSubmit(e)} className='flex flex-col grow'>
                    <div className='grid grid-cols-2 p-5 gap-5'>
                        {!originalData[index].firstname && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].lastname && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].email && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].fathername && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].mothername && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].rollnumber && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].Fee && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].course && <div className={inputContainerStyles}>
                        ...
                        {!originalData[index].address && <div className={inputContainerStyles}>
